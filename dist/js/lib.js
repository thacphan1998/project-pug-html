...
!(function (t, e) {
  ...
  var h,
    r =
      ...
      function () {
        var e = []
        return e.push.apply(e, arguments), t.extend(e, h), e
      }),
    o = function (e, i) {
      ;(this.dates = new r()),
        (this.viewDate = s()),
  ...
  o.prototype = {
    ...
    _process_options: function (e) {
      ...
      var i = (this.o = t.extend({}, this._o)),
        a = i.language
      switch (
        (p[a] || ((a = a.split('-')[0]), p[a] || (a = c.language)),
        (i.language = a),
        i.startView)
      ) {
        case 2:
      ...
      if (
        ...
        if (1 === n.length)
          ...
          (h = t.grep(n, function (t) {
            return /^left|right$/.test(t)
          })),
            (i.orientation.x = h[0] || 'auto'),
            (h = t.grep(n, function (t) {
              return /^top|bottom$/.test(t)
            })),
            (i.orientation.y = h[0] || 'auto')
      else;
    },
    _events: [],
    _secondaryEvents: [],
    ...
    place: function () {
      if (!this.isInline) {
        ...
        'auto' === g &&
          ((p = -h + o.top - a),
          (f = h + n - (o.top + d + a)),
          (g = Math.max(p, f) === f ? 'top' : 'bottom')),
          this.picker.addClass('datepicker-orient-' + g),
          'top' === g
            ? (u += d)
            : (u -= a + parseInt(this.picker.css('padding-top'))),
          this.picker.css({ top: u, left: c, zIndex: r })
      }
    },
    _allow_update: !0,
    update: function () {
    ...
    fill: function () {
      ...
      this.picker
        ...
        .text(p[this.o.language].months[n] + ' ' + s),
        this.picker
          .find('tfoot th.today')
          .text(l)
      ...
      u.setUTCDate(g),
        u.setUTCDate(g - ((u.getUTCDay() - this.o.weekStart + 7) % 7))
      var v = new Date(u)
      ...
      for (var D, m = []; u.valueOf() < v; ) {
        if (
          ...
          var y = new Date(
            ...
            T = new Date(
              Number((T = a(w.getUTCFullYear(), 0, 1))) +
        ...
        if (
          ...
          void 0 === C
            ...
            !1 === C.enabled && D.push('disabled'),
            C.classes && (D = D.concat(C.classes.split(/\s+/))),
        ...
        ;(D = t.unique(D)),
          ...
          u.getUTCDay() === this.o.weekEnd && m.push('</tr>'),
      ...
      t.each(this.dates, function (t, e) {
        ...
        (s < h || s > o) && _.addClass('disabled'),
        s === h && _.slice(0, r).addClass('disabled'),
        s === o && _.slice(d + 1).addClass('disabled'),
        (m = ''),
      ...
      for (
        ...
        (U = ['year']),
          -1 === x ? U.push('old') : 10 === x && U.push('new'),
          -1 !== t.inArray(s, M) && U.push('active'),
          (s < h || s > o) && U.push('disabled'),
          (m += '<span class="' + U.join(' ') + '">' + s + '</span>'),
          (s += 1)
      b.html(m)
    },
    ...
    click: function (e) {
      ...
      var i,
        s,
        n,
        h = t(e.target).closest('span, td, th')
      if (1 === h.length)
        switch (h[0].nodeName.toLowerCase()) {
          case 'th':
            switch (h[0].className) {
              ...
              case 'today':
                var o = new Date()
                ;(o = a(o.getFullYear(), o.getMonth(), o.getDate(), 0, 0, 0)),
                  this.showMode(-2)
          ...
          case 'span':
            h.is('.disabled') ||
              ...
              h.is('.month')
                ? ((n = 1),
                  (s = h.parent().find('span').index(h)),
                  (i = this.viewDate.getUTCFullYear()),
                  this.viewDate.setUTCMonth(s),
                  this._trigger('changeMonth', this.viewDate),
                  1 === this.o.minViewMode && this._setDate(a(i, s, n)))
                : ((n = 1),
                  (s = 0),
                  (i = parseInt(h.text(), 10) || 0),
                  this.viewDate.setUTCFullYear(i),
                  this._trigger('changeYear', this.viewDate),
                  2 === this.o.minViewMode && this._setDate(a(i, s, n))),
              this.showMode(-1),
              this.fill())
            break
          case 'td':
            h.is('.day') &&
              ...
              h.is('.old')
                ? 0 === s
                  ? ((s = 11), (i -= 1))
                  : (s -= 1)
                : h.is('.new') && (11 === s ? ((s = 0), (i += 1)) : (s += 1)),
              this._setDate(a(i, s, n)))
        }
      this.picker.is(':visible') &&
        this._focused_from &&
            ...
            ;(e = 37 === t.keyCode ? -1 : 1),
              t.ctrlKey
                ...
                ? ((i = this.moveMonth(this.dates.get(-1) || s(), e)),
                  (a = this.moveMonth(r, e)),
                  this._trigger('changeMonth', this.viewDate))
                : ((i = new Date(this.dates.get(-1) || s())).setUTCDate(
                    i.getUTCDate() + e,
                  ),
                  (a = new Date(r)).setUTCDate(r.getUTCDate() + e)),
            ...
            ;(e = 38 === t.keyCode ? -1 : 1),
              t.ctrlKey
                ...
                : ((i = new Date(this.dates.get(-1) || s())).setUTCDate(
                  ...
                  (a = new Date(r)).setUTCDate(r.getUTCDate() + 7 * e)),
              this.dateWithinRange(i) &&
                ((this.focusDate = this.viewDate = a),
                this.setValue(),
                this.fill(),
      ...
      this.each(function () {
        ...
        if (!n) {
          var r = (function (e, i) {
              ...
              for (var r in ((i = new RegExp('^' + i.toLowerCase())), a))
                i.test(r) && (s[r.replace(n, h)] = a[r])
              return s
            })(this, 'date'),
            l = (function (e) {
              var i = {}
            ...
            })(t.extend({}, c, r, h).language),
            f = t.extend({}, c, l, r, h)
          if (s.is('.input-daterange') || f.inputs) {
            var g = { inputs: f.inputs || s.find('input').toArray() }
    ...
    f = {
      ...
      parseDate: function (e, i, s) {
        if (e) {
          ...
          if (/^[\-+]\d+[dmwy]([\s,]+[\-+]\d+[dmwy])*$/.test(e)) {
            for (e = new Date(), r = 0; r < l.length; r++)
              switch (((n = d.exec(l[r])), (h = parseInt(n[1])), n[2])) {
                case 'd':
                  e.setUTCDate(e.getUTCDate() + h)
                  break
                case 'm':
                  e = o.prototype.moveMonth.call(o.prototype, e, h)
                  break
                case 'w':
                  e.setUTCDate(e.getUTCDate() + 7 * h)
                  break
                case 'y':
                  e = o.prototype.moveYear.call(o.prototype, e, h)
              }
            return a(
              e.getUTCFullYear(),
              e.getUTCMonth(),
          ...
          ;(D.M = D.MM = D.mm = D.m),
            (D.dd = D.d),
            (e = a(e.getFullYear(), e.getMonth(), e.getDate(), 0, 0, 0))
          var m = i.parts.slice()
          if (
            (l.length !== m.length &&
              (m = t(m)
            ...
            for (r = 0, y = m.length; r < y; r++) {
              if (((c = parseInt(l[r], 10)), (n = m[r]), isNaN(c)))
                switch (n) {
                  case 'MM':
                    ;(u = t(p[s].months).filter(k)),
                      (c = t.inArray(u[0], p[s].months) + 1)
                    break
                  case 'M':
                    ;(u = t(p[s].monthsShort).filter(k)),
                      (c = t.inArray(u[0], p[s].monthsShort) + 1)
                }
              g[n] = c
            }
            for (r = 0; r < v.length; r++)
              (T = v[r]) in g &&
                !isNaN(g[T]) &&
                ((w = new Date(e)), D[T](w, g[T]), isNaN(w) || (e = w))
          }
          return e
        }
        function k() {
          var t = this.slice(0, l[r].length)
          return t === l[r].slice(0, t.length)
        }
      },
      formatDate: function (e, i, a) {
        ...
        ;(s.dd = (s.d < 10 ? '0' : '') + s.d),
          ...
          (e = [])
        for (
          var n = t.extend([], i.separators), h = 0, r = i.parts.length;
          h <= r;
          h++
        )
          n.length && e.push(n.shift()), e.push(s[i.parts[h]])
        return e.join('')
      },
      headTemplate:
...
const btnLeftSlideType1 =
  '<a href="#" title="Trước" class="btnSlide btnSlideType1 left"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512"><path fill="currentColor" d="M447.1 256C447.1 273.7 433.7 288 416 288H109.3l105.4 105.4c12.5 12.5 12.5 32.75 0 45.25C208.4 444.9 200.2 448 192 448s-16.38-3.125-22.62-9.375l-160-160c-12.5-12.5-12.5-32.75 0-45.25l160-160c12.5-12.5 32.75-12.5 45.25 0s12.5 32.75 0 45.25L109.3 224H416C433.7 224 447.1 238.3 447.1 256z"/></svg></a>'

const btnRightSlideType1 =
  '<a href="#" title="Sau" class="btnSlide btnSlideType1 right"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512"><path fill="currentColor" d="M438.6 278.6l-160 160C272.4 444.9 264.2 448 256 448s-16.38-3.125-22.62-9.375c-12.5-12.5-12.5-32.75 0-45.25L338.8 288H32C14.33 288 .0016 273.7 .0016 256S14.33 224 32 224h306.8l-105.4-105.4c-12.5-12.5-12.5-32.75 0-45.25s32.75-12.5 45.25 0l160 160C451.1 245.9 451.1 266.1 438.6 278.6z"/></svg></a>'
...
function showBtnScrollTop() {
  if ($('.btnScrollTop').length) {
    ...
    if (windowScrollTop > 1) $('.btnScrollTop').fadeIn()
    else $('.btnScrollTop').fadeOut()
  }
}
